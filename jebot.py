...
async def start(client, message):
   if message.chat.type == 'private':
       await Jebot.send_message(
               ...
               text="""<b>Hola Soy el Accs TS Bot

Puedo descargar vídeo o audio de Youtube, Pornhub, Xhamster y algunos otros sitios +18. Hecho por @faay2021.

Pulsa el botón de ayuda para obtener más información sobre cómo usarme</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "Ayuda", callback_data="Ayuda"),
                                        InlineKeyboardButton(
...
@Jebot.on_message(filters.command("Ayuda"))
...
Únete a @ancientb para poder usarme</b>""",
        reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "Volver", callback_data="start"),
                                        InlineKeyboardButton(
                                            "Sobre Mi", callback_data="Sobre"),
                                  ],[
                                        InlineKeyboardButton(
                                            "Bot de cuentas premium", url="https://t.me/accstg_bot")
                                    ]]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")

@Jebot.on_message(filters.command("Sobre"))
async def about(client, message):
    if message.chat.type == 'private':   
        await Jebot.send_message(
               chat_id=message.chat.id,
               text="""<b>Información Mía!</b>

<b>Creador :</b> <a href="https://t.me/faay2021"></a>

<b Canal Del dueño:</b> <a href="https://t.me/ancientb"></a>

<b>Gracias Por usarme </b>""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "Volver", callback_data="start"),
        ...
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=message.chat.id,
                    text="Lo siento estás baneado para usarme. Contacta a mi [Dueño para saber que pasó](https://t.me/faay2021).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await c.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Bot de cuentas premium", url=f"https://t.me/accstg_bot")
                        ]
                    ]
                ),
                parse_mode="markdown"
...
async def callback_query_ytdl_audio(_, callback_query):
    try:
        ...
        with YoutubeDL(ydl_opts) as ydl:
            ...
            # download
            await callback_query.edit_message_text("**Obteniendo audio.**")
...
async def callback_query_ytdl_video(_, callback_query):
    try:
        ...
        with YoutubeDL(ydl_opts) as ydl:
            ...
            info_dict = ydl.extract_info(url, download=False)
            # download
            await callback_query.edit_message_text("**Obteniendo vídeo...**")
            ydl.process_info(info_dict)
            # upload
